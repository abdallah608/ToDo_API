...
<div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
  ...
  <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
    <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #5c91ad;font-family: 'Open Sans', sans-serif;" href="https://todoapi-u5oz.onrender.com/user/verify/${token}">Click here</a><![endif]>
